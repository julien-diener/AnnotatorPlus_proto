...
public class EvaluationAnnotators {
	...
	public static void NCBOAnnotatorEN(String directoryPath) 
	{
		...
		//moyen du rappel et de pr�cision corpus
		System.out.println("Rappel t : "+RappelTotale/nbArticles);
		System.out.println("Pr�cision  t: "+precisionTotale/nbArticles);
		//rappel et de pr�cision par corpus
		System.out.println("Rappel : "+nbAnnotationRetrouvee*100/nbAnnotationTotalePubMed);
		System.out.println("Pr�cision : "+nbAnnotationRetrouvee*100/nbAnnotationTotaleNCBO);
	}
	public static void NCBOAnnotatorEN2(String directoryPath) 
	{
	 ...
	 ConceptOrdPubMed = new ArrayList<String>();
		...
		System.out.println("Pr�cision 20: "+p);
		 p=precisionpar(50);
		System.out.println("Pr�cision 50: "+p);
		 p=precisionpar(100);
			System.out.println("Pr�cision 100: "+p);
		 p=precisionpar(500);
		System.out.println("Pr�cision 500: "+p);
		 p=precisionpar(1000);
			System.out.println("Pr�cision 1000: "+p);
			 p=precisionpar(1500);
				System.out.println("Pr�cision 1500: "+p);
				 p=precisionpar(2000);
					System.out.println("Pr�cision 2000: "+p);
					 p=precisionpar(2500);
						System.out.println("Pr�cision 2500: "+p);
	...
	public static void FMTIEN(String directoryPath) 
	{
		...
		//rappel et de pr�cision par corpus
		System.out.println("Rappel : "+nbAnnotationRetrouvee*100/nbAnnotationTotalePubMed);
		System.out.println("Pr�cision : "+nbAnnotationRetrouvee*100/nbAnnotationTotaleFMTI);
	...
	public static void FMTIFR(String directoryPath) 
	{
		...
		System.out.println("Rappel t : "+RappelTotale/nbArticles);
		System.out.println("Pr�cision  t: "+precisionTotale/nbArticles);
		//rappel et  pr�cision dans tous le corpus 
		System.out.println("Rappel : "+nbAnnotationRetrouvee*100/nbAnnotationTotalePubMed);
		System.out.println("Pr�cision : "+nbAnnotationRetrouvee*100/nbAnnotationTotaleFMTI);
	}
	...
	public static void ECMTFR(String directoryPath) 
	{
		...
		System.out.println("Rappel t : "+RappelTotale/nbArticles);
		System.out.println("Pr�cision  t: "+precisionTotale/nbArticles);
		// rappel et  pr�cision t le corpus dans tou corpus 
		System.out.println("Rappel : "+nbAnnotationRetrouvee*100/nbAnnotationTotalePubMed);
		System.out.println("Pr�cision : "+nbAnnotationRetrouvee*100/nbAnnotationTotaleECMT);
	}
	...
	/*public static void ECMTFR(String directoryPath) 
	{
		...
		System.out.println("Pr�cision : "+nbAnnotationRetrouvee*100/ListeAnnotationECMT.size());
		//Rappel=5, et Pr�cision=3
		//Rappel=4, et Pr�cision=11
	}
