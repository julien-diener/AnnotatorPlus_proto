...
public class Interface<JPael> extends JFrame implements ActionListener {
    ...
    private static final long serialVersionUID = -2248400093487603542L;
    ...
    public Interface() {
        ...
        box.setBorder(BorderFactory.createTitledBorder("Methode de scoring"));

        JPanel box4 = new JPanel();
        box4.add(new JRadioButton("Methode 1", true));
        box4.add(new JRadioButton("Methode 2", false));
        box4.setBorder(BorderFactory.createTitledBorder("Methode de classement"));

        JPanel box1 = new JPanel();
        JButton button = new JButton("Ouvrir le fichier a scorer");

        box1.add(button);
        box1.setBorder(BorderFactory.createTitledBorder("Fichier a scorer"));
        bg2.add(box);
        bg2.add(box4);
        bg2.add(box1);
        ...
        JLabel instructionlabel = new JLabel("R�sultats de scoring");
        ...
        JButton button2 = new JButton("Sauvgarder le r�sultat");
        box2.add(button2);
