package org.annotatorplus.server.scoring;
//package Scoring;
...
public class Comparaison {
	...
	public static void TitreAbstractArticles(String directoryPath) 
	{
		...
		if(!directory.exists()){
		 ...
		 try { 
	          File file = new File("F:\\MasterBCD\\Stage\\corpus\\Resum�+titre\\"+nomArticle.substring(0, nomArticle.length()-3)+"txt");
	...
	public static void AnnotationsArticles(String directoryPath) 
	{
		...
		if(!directory.exists()){
			...
			for(int i=0 ; i<subfiles.length; i++)
			{
					...
					while(ii.hasNext())
				{
					...
					{	
						...
						System.out.println("Concept : "+K+" ("+xmlfile.ListeAnnotationPubmedname.get(KK)+")"+"present dans Texte ="+res+", hi�rarchie ="+classeLireJSON.d.Dictscoreconcept.get(K).herarchie+" : "+classeLireJSON.d.Dictscoreconcept.get(K).ClassementScore+"/"+classeLireJSON.ClassementMax+" , "+classeLireJSON.d.Dictscoreconcept.get(K).ClassementScoreF+"/"+classeLireJSON.ClassementMaxF +" , "+classeLireJSON.d.Dictscoreconcept.get(K).ClassementScoreF2+"/"+classeLireJSON.ClassementMaxF2+"|| "+s1+" , "+s2+" , "+s3);
						 output.write("Concept : "+K+" ("+xmlfile.ListeAnnotationPubmedname.get(KK)+")"+" hi�rarchie ="+classeLireJSON.d.Dictscoreconcept.get(K).herarchie+" : "+classeLireJSON.d.Dictscoreconcept.get(K).ClassementScore+"/"+classeLireJSON.ClassementMax+" , "+classeLireJSON.d.Dictscoreconcept.get(K).ClassementScoreF+"/"+classeLireJSON.ClassementMaxF +" , "+classeLireJSON.d.Dictscoreconcept.get(K).ClassementScoreF2+"/"+classeLireJSON.ClassementMaxF2+"|| "+s1+" , "+s2+" , "+s3+"\n");
									}
				}
				}
			...
			System.out.println("Nb articles trait�s: "+nbTotaleArticles+"/"+cpt+"("+nbTotaleArticles*100/cpt+"%)");
			output.write("Nb articles trait�s:"+nbTotaleArticles+"\n");
			...
			System.out.println("nb cas egalit� :"+cptegale+"/"+nbTotaleConcepts+" ("+cptegale*100/nbTotaleConcepts+"%)"+"\n");
			  output.write("nb cas egalit� :"+cptegale+"/"+nbTotaleConcepts+" ("+cptegale*100/nbTotaleConcepts+"%)"+"\n");
			  System.out.println("nb cas  am�lioration F1 et F2 :"+cptameliore+"/"+nbTotaleConcepts+" ("+cptameliore*100/nbTotaleConcepts+"%)"+"\n");
			  output.write("nb cas  am�lioration F1 et F2 :"+cptameliore+"/"+nbTotaleConcepts+" ("+cptameliore*100/nbTotaleConcepts+"%)"+"\n");
			  System.out.println("nb cas pas am�lioration  :"+cptpasameliore+"/"+nbTotaleConcepts+" ("+cptpasameliore*100/nbTotaleConcepts+"%)"+"\n");
			  output.write("nb cas pas am�lioration  :"+cptpasameliore+"/"+nbTotaleConcepts+" ("+cptpasameliore*100/nbTotaleConcepts+"%)"+"\n");
			  System.out.println("nb cas am�lioration  F1 :"+cptamelioreF1+"/"+nbTotaleConcepts+" ("+cptamelioreF1*100/nbTotaleConcepts+"%)"+"\n");
			  output.write("nb cas am�lioration  F1 :"+cptamelioreF1+"/"+nbTotaleConcepts+" ("+cptamelioreF1*100/nbTotaleConcepts+"%)"+"\n");
			  System.out.println("nb cas  am�lioration  F2 :"+cptamelioreF2+"/"+nbTotaleConcepts+" ("+cptamelioreF2*100/nbTotaleConcepts+"%)"+"\n");
			  output.write("nb cas  am�lioration  F2 :"+cptamelioreF2+"/"+nbTotaleConcepts+" ("+cptamelioreF2*100/nbTotaleConcepts+"%)"+"\n");
			
			  System.out.println("Statistiques sur les concept am�lior�s F+F2:");
			  ...
			  System.out.println("Statistiques sur les concept non am�lior�s:");
			 ...
			 System.out.println("NB Concepts non presents dans le texte:"+(cptpasameliore-StatistiquePasAmelioration.nb_presentsTextes)+"/"+cptpasameliore+" ("+(cptpasameliore-StatistiquePasAmelioration.nb_presentsTextes)*100/cptpasameliore+"%)"+"\n");
			  ...
			  System.out.println("Statistiques sur l'�galit�:");
