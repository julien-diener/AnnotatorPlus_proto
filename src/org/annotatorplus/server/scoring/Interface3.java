...
public class Interface3<JPael> extends JFrame implements ActionListener
{
    ...
    {
        super();
        this.setTitle("Repr�sentation des annotations sous format RDF");
        ...
        JMenuItem menu_fichier_close = new JMenuItem("Repr�sentation des annotation sous format RDF");
        ...
        JButton button = new JButton("Ouvrir le fichier � repr�senter sous format RDF");
        JPanel bg2 = new JPanel();
        bg2.setBackground(new Color(200,200,200));
        this.add(bg2);
        box1.add(button);
        box1.setBorder(BorderFactory.createTitledBorder("Fichier � repr�senter sous format RDF"));
        bg2.add(box1);
        
        //
        JPanel CreationPanel = new JPanel();
        CreationPanel.setLayout(new BorderLayout());
        JLabel  instructionlabel = new JLabel("Annotations repr�sent�es sous format RDF");
