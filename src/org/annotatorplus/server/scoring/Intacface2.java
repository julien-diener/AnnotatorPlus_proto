...
//Linterface pour le choix de traitement � effectuer 1-Scoring des annotations ou 2-Repr�sentation des annotation sous format RDF 
public class Intacface2<JPael> extends JFrame implements ActionListener
{
    ...
    {
        super();
        this.setTitle("Am�lioration du processus d�annotation de l�annotateur de NCBO ");
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        else if(e.getActionCommand().equals("Representation des annotation sous format RDF"))
            {
