...
public class StructScore 
{
	public ArrayList TermesAnnotes;
	public  int score;
	...
	StructScore (ArrayList TermesAnnotes,int score,double scoreF, double scoreF2,JSONObject annotatedClass,Boolean trie,Boolean trieF,Boolean trieF2,Boolean herarchie,int ClassementScore, int ClassementScoreF, int ClassementScoreF2) 
	{
